...
if(opts.title&&!opts.noheader){	//siyaa 控制弹出层title颜色
var _1da=$("<div class=\"panel-header\"><div class=\"panel-title siyaa\">"+opts.title+"</div></div>").prependTo(_1d9);
if(opts.iconCls){
...
if(opts.closable){
$("<a class=\"panel-tool-close close_btn\" href=\"javascript:void(0)\"></a>").appendTo(tool).bind("click",function(){
_1db(_1d8);
return false;
});
}
...
if(typeof($.data(_1eb,"panel")) == 'undefined') return;
...
win.children("div.messager-button").children("a:first");//.focus(); 取消弹出层确定选中
return win;
};
